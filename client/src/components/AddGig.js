        ...
        <div>
            <section id="add" className="container">
                  ...
                  <form action="/add" method="POST" onSubmit={this.handleSubmit}>
                      ...
                      className="input-box" placeholder="eg. Small Wordpress website, React developer"
                      maxLength="100" 
                      ...
                      className="input-box" placeholder="eg. javascript, react, PHP"
                      maxLength="100" 
                      onChange={this.handleChange}
                      ...
                      className="input-box" placeholder="eg. 500, 5000, 10000" 
                      onChange={this.handleChange}
                      ...
                      placeholder="Describe the details of the gig" rows="10"
                      onChange={this.handleChange}
                      ...
                      <input type="email" name="contact_email" id="contactemail" className="input-box" 
